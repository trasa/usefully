...
/**
 * This is the 'classic' Key format.
 *
 *
 *
 ...
 *
 */
public class MessageHeaderKeyStrategy implements StaticKeyStrategy {
    private static final Logger logger = LoggerFactory.getLogger(MessageHeaderKeyStrategy.class);
